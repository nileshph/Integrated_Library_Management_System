...
<body>
                        ...
                        <div id="danger-zone" class="tab-content">
                            <div id="home" class="tab-pane fade in active">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" id="keyword-item" class="form-control">
                                    <br>
                                    <label>Enter Category:</label>
                                    <input type="text" id="keyword-category" class="form-control">




                                    </div>
                                    <button id="btn-gen-search" class="btn btn-default"><i class="fa fa-search">Search</i></button>
                                    <button class="btn btn-default"><a href="search.php">Back</a></button>
    ...
    <script>
        ...
        $('#res-gen-search').hide();
        var item = $('#keyword-item').val();
        var category = $('#keyword-category').val();
        /*console.log(keyword);*/
        $.ajax({
            url:"advance_search_item.php",
            dataType: "json",
            type:"GET",
            ...
            success:function(bookList){
                ...
                $('#res-gen-search').html('<tr><th>Item Id</th><th>Title</th><th>Publication</th><th>Quantity</th><th>Type</th><th>Actions</th></tr>');
