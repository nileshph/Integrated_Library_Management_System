    ...
    <div id="wrapper">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <li class="active">
                            <a href="#"><i class="fa fa-fw fa fa-archive"></i> Delete Item</a>
                        </li>
                    </ul>
                </li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa fa-fw fa fa-archive"></i>
                           Delete Items
                        </h1>
                    </div>
                </div>
                 <div class="row">
                    <div class="col-lg-12">
                        ...
                        <tr><td align="right"><input type="submit" value="Delete Item" onclick="return confirm('Are you sure?')"/></td>
