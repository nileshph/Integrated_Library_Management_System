                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Fines
                            <small>Orders past due date and fines</small>
                        </h1>
                        <div class="col-lg-6">
                        <h2>My Fines</h2>
                        <div class="table-responsive">
                            <table id ='res-fines' class="table table-bordered table-hover table-striped">
        ...
        $(document).ready(function(){
            ...
            $.ajax({
                ...
                success:function(fines){
                    console.log(fines);
                    $('#res-fines').empty();
                    $('#res-fines').html('<tr><th>Order Number</th><th>Amount</th><th>Payment Status</th></tr>');
                    for(var i = 0; i < fines.length; i++){
                        $('#res-fines').append('<tr><td>'+fines[i]['order_number']+'</td><td>'+fines[i]['amount']+'</td><td>'+fines[i]['payment_status']+'</td></tr>');
                    }
                    $('#res-fines').show();
                },
                error:function(){
