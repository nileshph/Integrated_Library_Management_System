    ...
    <div id="wrapper">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <li class="active">
                            <a href="#"><i class="glyphicon glyphicon-new-window"></i> Add Item</a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="glyphicon glyphicon-new-window"></i>
                           Add Items
                        </h1>
                    </div>
                </div>
                                        ...
                                        <tbody>
                        					...
                        					<tr>
                        						<td><label>Item Author: </label></td>
                       							<td> <input type="text" name="author_name" id="author_name"/></td></tr>
                        					<tr>
                        						<td><label>Item Quantity: </label></td>
                       							<td> <input type="text" name="quantity" id="quantity"/></td></tr>
                        <tr><td><label>Item Publication: </label></td>
                        <td><input type="text" name="publication" id="publication"/></td></tr>
                        <tr><td><label>Item Pages: </label></td>
                        <td><input type="text" name="pages" id="pages"/></td></tr>
                        <tr><td><label>Item Edition: </label></td>
                        <td><input type="text" name="edition" id="edition"/></td></tr>
                        <tr><td><label>Item Year: </label></td>
                        <td><input type="text" name="year" id="year"/></td></tr>
                        <tr><td align="right"><input type="submit" value="Add Item"/></td>
