                            ...
                            <a href="#">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h5 class="media-heading"><strong>Hello</strong>
                                        </h5>
                ...
                <div class="row">
                        ...
                        <div class="panel panel-red">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">
                                            <?php
                                                ...
                                                $sql = "select i.title from wishlist c,item i where c.card_id = " . $_SESSION ["card_number"] ." and
                                                        i.item_id = c.item_id";
                            ...
                            <a href="wishlist.php">
                                <div class="panel-footer">
                                    <span class="pull-left">View Wishlist</span>
                    ...
                    <div class="col-lg-4 col-md-8">
                        <div class="panel panel-yellow">
                            ...
                            <a href="fines.php">
                                <div class="panel-footer">
                                    <span class="pull-left">View Fines</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                                </div>
                            </a>
                            ...
                            <div class="panel-body">
                                <div class="list-group">
                                    <a href="#" class="list-group-item">
                                        ...
                                        <i class="fa fa-fw fa-money"></i> Paid fines
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">4 minutes ago</span>
                                        <i class="fa fa-shopping-cart"></i> Added movie Ghostbusters to cart
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">23 minutes ago</span>
                                        <i class="fa fa-fw fa-heart"></i> Wishlisted movie Ghostbusters
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">46 minutes ago</span>
                                        <i class="fa fa-fw fa-heart"></i> Wishlisted book Harry Potter and the Chamber of Secrets
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">1 hour ago</span>
                                        <i class="glyphicon glyphicon-pencil"></i> Returned movie Dr. Dolittle
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">2 hours ago</span>
                                        <i class="fa fa-fw fa-heart"></i> Wishlisted book Ruby on Rails
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">yesterday</span>
                                        <i class="fa fa-fw fa-globe"></i> Changed theme to Halloween
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">two days ago</span>
                                        <i class="fa fa-fw fa-book"></i> Returned book Harry Potter and the Sorcerer's Stone
                                    </a>
                                </div>
